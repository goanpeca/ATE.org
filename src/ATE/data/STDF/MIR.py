...
# -*- coding: utf-8 -*-
"""
Created on Sat May 23 12:32:32 2020
    ...
    def __init__(self, version=None, endian=None, record=None):
        ...
        if self.version == 'V4':
            ...
            self.fields = {
                ...
                'SETUP_T'  : {'#' :  3, 'Type' : 'U*4', 'Ref' : None, 'Value' : None, 'Text' : 'Date and time of job setup            ', 'Missing' : missing_time},
                'START_T'  : {'#' :  4, 'Type' : 'U*4', 'Ref' : None, 'Value' : None, 'Text' : 'Date and time first part tested       ', 'Missing' : missing_time},
