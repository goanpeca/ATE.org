...
1. A `HTOL group` must have also a `Reference`
...
1. It depends on the 'Reference' is movement is possible at all, but even if it is not, we have a nice overview of the HTOL-Group.
