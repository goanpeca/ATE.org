...
class TestWizard(QtWidgets.QDialog):
    ...
    def OKButtonPressed(self):
        ...
        definition = {}
        definition.update({'input_parameters': self.definition['input_parameters']})
        definition.update({'output_parameters': self.definition['output_parameters']})
        definition.update({'docstring': self.definition['docstring']})
        self.project_info.add_or_update_test(self.definition['name'],
...
def edit_test_dialog(project_info, definition):  # TODO: add the data still
    editTestWizard = TestWizard(project_info, definition=definition, read_only=True)
