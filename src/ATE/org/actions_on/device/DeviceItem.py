...
from ATE.org.actions_on.device.EditDeviceWizard import edit_device_dialog
from ATE.org.actions_on.device.ViewDeviceWizard import display_device_settings_dialog
