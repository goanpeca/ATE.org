...
from masterApp.master_application import MasterApplication
from common.connection_handler import ConnectionHandler
from masterApp.master_webservice import WebsocketCommunicationHandler

class TestWebsocketCommunicationHandler:

    def setup_method(self):
        config = {"sites" : [0], "device_id": "foobar", "broker_host" : "192.168.0.1", "broker_port" : "4000"}
