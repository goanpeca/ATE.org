...
from ATE.apps.launch_master import launch_master
from ATE.apps.launch_control import launch_control
from ATE.apps.launch_testapp import launch_testapp
import time
import asyncio
import aiohttp
import json
...
TESTZIPMOCKS = ['example1', 'example3']
