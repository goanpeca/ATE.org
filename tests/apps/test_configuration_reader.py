...
CONFIG_FILE_PATH = "./tests/apps/config_file_test.json"
CONFIG_FILE_PATH_USER = "./tests/apps/config_file_test_partial_user.json"
CONFIG_FILE_PATH_BAD = "./tests/apps/config_file_test_bad.json"
